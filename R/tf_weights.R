#Solves trendfiltering with weights.
...
trendfilter_weights <- function(y, pos, weights=NULL, ord=0, approx=FALSE, maxsteps=2000,
  ...
  if(any(weights==0)) stop("All weights must be non-zero.")
  if(is.null(weights)){
